...
| [Dev and staging environments](dev-and-staging-environments.md) | Compose stacks, ports, MariaDB, Flyway, JWKS, payment env vars, SPA tokens |
| [Bookshop API OpenAPI](bookshop-api.openapi.yaml) | HTTP API sketch: catalog, currency, checkout purchase, payment webhook |
