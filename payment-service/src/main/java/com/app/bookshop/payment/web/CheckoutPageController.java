package com.app.bookshop.payment.web;

import java.net.URI;

import com.app.bookshop.payment.model.PaymentSession;
import com.app.bookshop.payment.service.BookshopWebhookClient;
import com.app.bookshop.payment.service.PaymentSessionStore;
...
public class CheckoutPageController {
    ...
    private final BookshopWebhookClient webhookClient;

    public CheckoutPageController(PaymentSessionStore store, BookshopWebhookClient webhookClient) {
        this.store = store;
